...
// func (a *UserRepo) Query(ctx context.Context,
// 	params schema.UserQueryParam,
// 	opts ...schema.UserQueryOptions) (*schema.UserQueryResult, error) {

func (a *ArticleRepo) FindArticle(ctx context.Context, condition map[string]interface{}) (*models.Article, error) {
	var article models.Article

	db := models.GetArticleDB(ctx, a.DB)
...
// func FindArticleCron(condition map[string]interface{}) (*models.Article, error) {
// 	var article models.Article
...
// func UpdateArticle(condition map[string]interface{}, article models.Article) bool {
...
// func UpdateViewed(condition map[string]interface{}, viewed int) {
...
// func GetAllArticles(pagination *pkg.Pagination) (*pkg.Pagination, error) {
// 	var articles []models.Article
// 	var totalRows int64
...
// func GetAllArticlesCron(pagination *pkg.Pagination) (*pkg.Pagination, error) {
// 	var articles []models.Article
// 	var totalRows int64
// 	if len(pagination.Condition) == 0 {
// 		s.db.Model(&articles).Count(&totalRows)
...
// func GetAllArticlesByIds(ids []int, pagination *pkg.Pagination) (*pkg.Pagination, error) {
// 	var articles []models.Article
// 	var totalRows int64
...
// func FindArticleOther(tagId []int, pagination *pkg.Pagination) (*pkg.Pagination, error) {
// 	var articles []models.Article
// 	var totalRows int64
// 	if len(tagId) > 0 {
// 		s.db.Select(
